	 ...
	 @if(Auth::user()->type == 'STAFF')
        ...
        <form action="{{ route('image.upload.post') }}" method="POST" enctype="multipart/form-data">
            @csrf
            	...
            	<div class="row col-sm-12">
            		<b class="col-sm-2">DOB: </b><input type="date" name="dob" class="col-sm-2 form-control" required>
            	</div>
            	<div class="row col-sm-12">
            	...
            	<div class="row col-sm-12">
            		<b class="col-sm-2">Description: </b><textarea type="text" name="desc" id="new-animal-desc" class="col-sm-6 form-control" required></textarea>
            	</div>
                <div class="row col-sm-12" style="height: 40px;">
                    <b class="col-sm-2">Primary Image: </b><input type="file" id="primary-image-input" style="height: 30px;" name="image" class="col-sm-2 form-control" required>               
					 ...
					 <div class="row col-sm-12" style="height: 40px;">
                   <a href="#" class="col-sm-2 btn" style="font-size: 100%;" id="more"
