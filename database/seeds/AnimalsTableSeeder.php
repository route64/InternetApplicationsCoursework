    ...
    public function run()
    {
        //created an instance of Faker class to the variable $faker
			...
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/1GreyCat_Trissy1.jpg',
				'adopted' => 0,
				'created_at' => $date          
			]);
			//id=2
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/2SyrianHamster_lg_Tony1.jpg',
				'adopted' => 0,
				'created_at' => $date
			]);
			//id=3
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/3GoldenRetriever_Sandy1.jpg',
				'adopted' => 0,
				'created_at' => $date       
			]);
			//id=4
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/4GermanShepherd_Giles1.jpg',
				'adopted' => 0,
				'created_at' => $date
			]);
			//id=5
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/5BlueParrot_Tesha1.jpg',
				'adopted' => 0,
				'created_at' => $date
			]);
			//id=6
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/6BrownGuinneaPig_Loki1.jpg',
				'adopted' => 0,
				'created_at' => $date
			]);
			//id=7
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/7OddEyedCat_Diddy1.jpg',
				'adopted' => 0,
				'created_at' => $date
			]);
			//id=8
			DB::table('animals')->insert([
				...
				'primary_image_location' => '../resources/images/Pets/8BlackAndWhiteRabbit_Twitchy.jpg',
				'adopted' => 0,
				'created_at' => $date 
			]);
    }
